...
<html lang="en" class="app">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/js/select2/select2.css" type="text/css" />
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/js/select2/theme.css" type="text/css" />
                                        ...
                                        <ul class="nav">
                                            ...
                                            <li >
                                                ...
                                                <ul class="nav lt">
                                                    ...
                                                    <li >
                                                        <a data-toggle="pageContent" href="App/Grn" >                                                        
                                                            <i class="fa fa-angle-right"></i>
                                                            <span>Good Recieving Notes</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                ...
                                <section class="panel panel-default">
                                    <div class="row m-l-none m-r-none bg-light lter">
                                        <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                                            ...
                                            <a class="clear" href="#">
                                                <span class="h3 block m-t-xs"><strong>10,500</strong></span>
                                        ...
                                        <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                                            ...
                                            <a class="clear" href="#">
                                                ...
                                                <small class="text-muted text-uc">Products</small>
                                            </a>
                                        </div>
                                        <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                                            <span class="fa-stack fa-2x pull-left m-r-sm">
