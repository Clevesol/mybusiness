<%-- 
    Document   : invoicen
    Created on : Jan 19, 2017, 12:49:16 AM
  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="${pageContext.request.contextPath}/resources/images/logo.png" class="m-r-sm">Notebook</a>
    ...
    <section>
      <section class="hbox stretch">
        ...
        <section id="content">
          ...
          <section style="visibility: hidden" class="vbox bg-white">
            <header class="header b-b b-light hidden-print">
                <div style="padding-top: 10px; padding-bottom: 10px" class="vbox">
                    <div class="col-sx-2"><button  class="btn btn-sm btn-info pull-right" onClick="window.print();">Print</button></div>
                    <div class="col-sx-10">
                        <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                            <li><a href="index.html"><i class="fa fa-home"></i>&nbsp;Invoicing</a></li>
                            <li class="active">Untitled Invoice</li>
                        </ul>
                    </div>
                </div>
            </header>
            ...
            <!-- end of existing invoice preview -->
