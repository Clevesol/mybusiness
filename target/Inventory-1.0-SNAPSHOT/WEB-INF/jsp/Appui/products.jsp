<%-- 
    Document   : products
    Created on : Jan 21, 2017, 5:04:16 PM
                                ...
                                <header class="panel-heading">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="pull-right">
                                            <button class="btn btn-default"><span class="fa fa-adjust">&nbsp;</span>Add New</button>
                                        </div>
                                    </div>
            ...
            <section id="content">
                <section class="hbox stretch">
                    <aside class="aside-md bg-white b-r" id="subNav">
                        ...
                        <ul class="nav">
                            <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Electric Hammer Drill</a></li>
                            <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Drill Bits</a></li>
                            <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Boned Abrasives & Diamond Products</a></li>
                            <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Wood Working Knives</a></li>
                        </ul>
                    </aside>
                    <aside>
                        <section class="vbox">
                            <header class="header bg-white b-b clearfix">
                                <div class="row m-t-sm">
                                    <div class="col-sm-8 m-b-xs">
                                        ...
                                        <a href="resources/modal.html" data-toggle="ajaxModal" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> Create</a>
                                    </div>
